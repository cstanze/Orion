...
extension OrionWindowController: WKNavigationDelegate {
  ...
  func webView(_ webView: WKWebView, didFailProvisionalNavigation navigation: WKNavigation!, withError error: Error) {
    ...
    case Code.timedOut:
      webView.loadHTMLString(Bundle.main.loadResource(withName: "ErrorTimedOut", ofType: "").replacingOccurrences(of: "__URL__", with: (webView.url ?? URL(string: "about:blank")!)!.absoluteString), baseURL: nil)
    default:
